        ...
        Ok(()) => {
            ...
            (
                ...
                Json(serde_json::json!({
                    ...
                    "binding_warning": if arrangement == "SINGLE_SOURCE" { Some("Single-source metadata capture is enabled, but this build does not materialize arbitrary macro bindings; use only verified template-owned bindings.") } else { None },
