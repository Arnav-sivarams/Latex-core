...
check_port HTTP "${http_port:-9000}"
# 54329 preserves the main-branch contract for legacy .env files. New files
# generated by this candidate explicitly contain 9001.
check_port PostgreSQL "${postgres_port:-54329}"
