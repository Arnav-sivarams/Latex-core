...
#[tokio::test]
async fn supported_single_source_known_macros_compile() {
...
\begin{document}
Title: \thesistitle\par Student: \studentAname\ (\studentAregno)\par
Guide: \projguidename\par Department: \hoddept\par School: \schoolname\par
\newpage Page two.\newpage Locate target phrase.\newpage Page four.\input{second.tex}
\end{document}";
    let definitions = br"% Generated by LaTeX Core.
\providecommand{\thesistitle}{}\renewcommand{\thesistitle}{Synthetic Alpha}
\providecommand{\studentAname}{}\renewcommand{\studentAname}{Alice Single}
\providecommand{\studentAregno}{}\renewcommand{\studentAregno}{REG-1}
\providecommand{\projguidename}{}\renewcommand{\projguidename}{Dr. Grace Guide}
\providecommand{\hoddept}{}\renewcommand{\hoddept}{Department Alpha}
\providecommand{\schoolname}{}\renewcommand{\schoolname}{School Alpha}";
    let (execution, _) = compile(
        &[
            ("main.tex", main),
            ("second.tex", b"Second source."),
            (".latex-core/frontmatter/Front-Matter.tex", definitions),
        ],
        "main.tex",
        TexEngine::PdfLatex,
